<x-layout>
    ...
    <x-button class="right-5 top-5 absolute" href="{{ route('movies.create') }}">{{ __('form.dashboard.button') }}</x-button>
        ...
        @foreach ($quotes as $quote)
            <div class="flex flex-col justify-center items-center w-[70vw] mx-auto text-black text-center">
                ...
                <div class="self-end  text-base flex flex-row">
                   <x-button class="mr-1" href="{{ route('quotes.create', $quote->movie->slug ) }}">{{ __('form.dashboard.create') }}</x-button>
